...
attribute "apache/default_modules",
  ...
  :default => "status alias auth_basic authn_file authz_default authz_groupfile authz_host authz_user autoindex dir env mime negotiation setenvif rewrite php5"
